...
课程不再要求每篇对应一个项目版本。Todo 平台按阶段累积形成以下可验收作品：
...
阶段性作品可以按阶段打 git tag，学习者可随时回溯到关键能力节点。
